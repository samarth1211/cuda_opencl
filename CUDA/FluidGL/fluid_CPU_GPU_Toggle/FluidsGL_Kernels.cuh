...
extern "C" void addForces(cData_float *v,int dx,int dy,int spx,int spy,float fx,float fy,int r);
extern "C" void addvectVelocity(cData_float *v,float *vx,float *vy,int dx,int pdx,int dy,float dt);
extern "C" void diffuseProject(cData_float *vx, cData_float *vy,int dx,int dy,float dt,float visc);
extern "C" void updateVelocity(cData_float *v,float *vx, float *vy,int dx,int pdx,int dy);
extern "C" void advectParticles(GLuint vbo,cData_float *v,int dx, int dy,float dt);
